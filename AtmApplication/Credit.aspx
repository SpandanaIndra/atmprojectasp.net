<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Credit.aspx.cs" Inherits="AtmApplication.Credit" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <div>
                <br />
                <asp:Button ID="btnCredit" runat="server" type="submit" Text="Credit" OnClick="btnCredit_Click"/>
                <br />
                <br />
                <br />
                <br />
